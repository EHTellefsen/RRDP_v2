...
class Final_Data:
    def __init__(self, count_head=0):
...
def plot(latitude, longitude, obsID, date, save_path_plot, HS='NH', obstype='', showplot = False):
    """
    ...
    plt.savefig(save_path_plot + '/' + obsID + '.png')
...
def scatter(obsID, date_pre, var_pre, date_post, var_post, varname, save_path_plot, showplot = False):
    """
    ...
    plt.title(obsID)
    plt.savefig(save_path_plot + '/' + obsID + varname +
...
def sort_final_data(ofile, save_path_plot, HS='NH', primary='SIT', showplot = False):
    """
    ...
    if primary == 'SIT':
        ...
        plot(data['lat'], data['lon'], 'All', dates, save_path_plot, HS=HS, showplot=showplot)
...
# =============================================================================
# # Reference function for correctly referencing directories
# =============================================================================
